...
.card-item { display: flex; align-items: center; gap: 12px; padding: 10px 0; border-bottom: 1px solid var(--color-border); }
.card-item:last-child { border-bottom: none; }
.card-chip {
  width: 44px; height: 28px; border-radius: 6px;
  display: flex; align-items: center; justify-content: center;
  font-size: 9px; font-weight: 700; letter-spacing: 0.5px; color: white; flex-shrink: 0;
}
.card-info { flex: 1; }
...
.utilization { margin-top: 1rem; padding-top: 14px; border-top: 1px solid var(--color-border); }
.util-label { font-size: 12px; color: var(--color-body); margin-bottom: 6px; }
.util-bar { height: 6px; background: var(--color-border); border-radius: 3px; overflow: hidden; }
.util-fill {
  height: 100%;
...
.util-meta { display: flex; justify-content: space-between; margin-top: 5px; }
